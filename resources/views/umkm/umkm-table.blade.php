        ...
        <div class="p-4">
            ...
            <form method="GET" action="{{ route('umkm') }}" class="mb-4">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('umkm') }}" class="bg-red-500 text-white px-4 py-2 rounded ml-2 hover:bg-red-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition ease-in-out duration-150">
