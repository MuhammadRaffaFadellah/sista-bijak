            ...
            <div class="p-4">
                <form action="{{ isset($lahir) ? route('lahir.update', $lahir->id) : route('lahir.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="nama_anak_lahir" class="block text-sm font-medium text-gray-700">Nama Anak
                                Lahir</label>
                            <input type="text" name="nama_anak_lahir" id="nama_anak_lahir"
                                placeholder="Silakan masukkan nama anak" value="{{ $lahir->nama_anak_lahir ?? '' }}"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-500" />
                        </div>
                        <div>
                            <label for="nama_ayah_kandung" class="block text-sm font-medium text-gray-700">Nama Ayah
                                Kandung</label>
                            <input type="text" name="nama_ayah_kandung" id="nama_ayah_kandung"
                                placeholder="Silakan masukkan nama ayah" value="{{ $lahir->nama_ayah_kandung ?? '' }}"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-500" />
                        </div>
                        <div>
                            ...
                            <input type="text" name="nama_ibu_kandung" id="nama_ibu_kandung"
                                placeholder="Silakan masukkan nama ibu" value="{{ $lahir->nama_ibu_kandung ?? '' }}"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-500" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" id="tempat_lahir"
                                placeholder="Silakan masukkan tempat lahir" value="{{ $lahir->tempat_lahir ?? '' }}"
                                required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-500" />
                        </div>
                        <div>
                            ...
                            <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                                value="{{ $lahir->tanggal_lahir ?? '' }}" required
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-green-500" />
                        </div>
                        <div>
                            ...
                            <select name="status_kependudukan" id="status_kependudukan" required
                                ...
                                @foreach ($statusKependudukanOptions as $option)
                                    <option value="{{ $option }}"
                                        {{ isset($lahir) && $lahir->status_kependudukan == $option ? 'selected' : '' }}>
                                        {{ $option }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="mt-10 mb-4 flex justify-between">
                        <a href="{{ route('resident-born') }}"
                            class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Kembali</a>
