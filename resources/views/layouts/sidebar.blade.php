...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
    <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
            <img src="{{ asset('img/sistabijak1.png') }}" alt="" class="h-100 w-150">

            <span class="mx-2 text-2l font-semibold text-white">SISTA BIJAK</span>
        </div>
    </div>
    ...
    <nav class="mt-10">
        ...
        <a class="{{ request()->is('users') ? 'bg-gray-700 bg-opacity-25' : '' }} flex items-center px-6 py-2 text-gray-100 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="#">
