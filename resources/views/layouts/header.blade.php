    ...
    <div class="flex items-center">
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            <button @click="dropdownOpen = ! dropdownOpen"
                class="relative block w-8 h-8 fill-blue-900 overflow-hidden rounded-full shadow focus:outline-none">
            ...
            <div x-cloak x-show="dropdownOpen"
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" id="logoutButton"
                        class="block flex w-full fill-cyan-800 items-center text-left px-4 py-2 text-sm text-gray-700 hover:fill-white hover:bg-cyan-800 hover:text-white">
...
<script>
    document.getElementById('logoutButton').addEventListener('click', function() {
        localStorage.removeItem('activePage'); // Hapus halaman aktif dari localStorage saat logout
    });
</script>