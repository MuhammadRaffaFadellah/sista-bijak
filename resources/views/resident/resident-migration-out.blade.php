    ...
    <div class="container mx-auto px-4 py-6">
        <div class="card shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-4">
                                ...
                                @foreach ($migrasiKeluar as $index => $migrasi)
                                    <tr class="hover:bg-gray-100 transition duration-200">
                                        <td class="px-4 py-2 whitespace-nowrap text-center">
                                            {{ $migrasiKeluar->firstItem() + $index }}.</td>
                                        ...
                                        <td class="px-4 py-2 whitespace-nowrap text-center space-x-2">
                                            <a href="{{ route('migrasikeluar.edit', $migrasi->id) }}" title="Edit data"
                                            ...
                                            <form action="{{ route('migrasikeluar.destroy', $migrasi->id) }}"
                ...
                <div class="mt-4">
                    {{ $migrasiKeluar->appends(request()->except('page'))->links() }} <!-- Pagination links -->
                </div>
            </div>
        </div>

        <!-- Modal Pencarian Penduduk -->
        <div id="searchPendudukModal"
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg relative w-full max-w-xl">
                ...
                <input type="text" id="searchInput" placeholder="Cari berdasarkan NIK atau Nama"
                    class="block w-full border border-gray-300 rounded-md p-2 mb-4">
                <button id="searchButton" onclick="searchValidate(event, this)"
        ...
        <div id="dataEntryModal"
            ...
            <div id="dataEntryContent"
                class="bg-white p-6 rounded-lg shadow-lg relative w-full max-w-xl opacity-0 scale-90 transition-transform duration-300">
        ...
        <div id="dataConfirmationModal"
            class="fixed inset-0 z-10 flex items-center justify-center bg-gray-800 bg-opacity-60 hidden">
            <div class="bg-white p-6 rounded-lg shadow-lg relative w-full max-w-xl">
                <button id="closeConfirmationModalButton"
