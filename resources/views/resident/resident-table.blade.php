        ...
        <div class="p-4">
            <form method="GET" action="{{ route('resident.table') }}" class="mb-4">
                <div class="flex items-center">
                    <input type="text" name="search" placeholder="Cari Nama atau NIK" class="border border-gray-300 rounded-md p-2 w-full" value="{{ request('search') }}">
                                ...
                                <tr class="hover:bg-gray-100 transition duration-200">
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap text-center">
                                        ...
                                        <form action="{{ route('penduduk.destroy', $penduduk->id) }}" method="POST" class="inline" id="deleteForm">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="deleteConfirm(event, this)" class="text-red-500 hover:text-red-600 px-2 py-1 border border-red-500 rounded">
