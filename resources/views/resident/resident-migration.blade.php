                    ...
                    <form method="GET" action="{{ route('resident-migration') }}" class="mb-4">
                        <div class="flex items-center">
                            <input type="text" name="search"
                                placeholder="Cari Jenis Migrasi, Nama Kepala Keluarga atau NIK"
                            ...
                            @if (Auth::user()->role->id === 1)
                                ...
                                <select name="filter_rw" class="border border-gray-300 rounded-md p-2 ml-2">
                                    ...
                                    @for ($i = 1; $i <= 7; $i++)
                                        <option value="{{ $i }}"
                                            {{ request('filter_rw') == $i ? 'selected' : '' }}>RW {{ $i }}
                                        </option>
                                    @endfor
                                </select>
                            @endif
                            ...
                            <a href="{{ route('resident-died') }}"
                                class="bg-gray-500 text-white px-4 py-2 rounded ml-2">Reset</a>
                        </div>
                    </form>
                    <!-- End Form Filter -->
